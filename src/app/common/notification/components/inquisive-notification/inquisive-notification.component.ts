...
import { Options } from '../../models/notification-options';
import { Subscription } from 'rxjs/Subscription';

@Component({
    selector: 'app-inquisive-notification',
    templateUrl: './inquisive-notification.component.html',
    styleUrls: ['./inquisive-notification.component.scss']
})
export class InquisiveNotificationComponent implements OnInit, OnDestroy {
