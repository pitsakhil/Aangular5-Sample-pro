...
import { AttachmentUrls } from '../constants';
...
export class FileQueueObject {
    ...
    public isCancel = () => this.status === FileQueueStatus.Cancelled;
...
export class FileUploaderService {
    ...
    public url: string = environment.API_UPLOAD_URL + AttachmentUrls.DOWNLOAD_API;
    private headers: any;
    ...
    private _upload(queueObj: FileQueueObject) {
        ...
        form.append('unique_path', queueObj.file.unique_path);
        form.append('sf_id', queueObj.file.sf_id);
    ...
    private _cancel(queueObj: FileQueueObject) {
        ...
        queueObj.progress = 0;
        queueObj.status = FileQueueStatus.Cancelled;
        this._queue.next(this._files);
    }
